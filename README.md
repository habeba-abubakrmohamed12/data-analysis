...
3. Open `notebooks/02_sql_analysis.ipynb` and run all cells
4. Open `notebooks/03_visualization_export.ipynb` and run all cells
5. Open Power BI Desktop, import the three CSVs from `data/processed/` per
